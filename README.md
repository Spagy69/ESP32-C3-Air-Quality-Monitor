...
- **Dělič sedí ve dvou bodech, 4.15 a 3.81 V (druhý změřený 28. 8. 2026).** Nahoře hlásily HA i multimetr shodně 4.15 V; teď při vybité půlce ukazuje HA **3.81 V** a multimetr **3.81-3.82 V**, tedy shoda v mezích odečtu. Násobič `* 3.2` je tím ověřený přes rozsah 3.81-4.15 V, ne jen v jednom bodě.
  ...
  **Podmínky odečtu:** červená sonda na **B+ přímo na baterce**, černá na **GND XIAO** - tedy ten samý uzel a ta samá zem, proti které měří ADC, takže je to srovnání jedna ku jedné a nemíchá se do něj úbytek na trase. Krabička běžela v **CESTA**, ale s **rozsvíceným displejem v režimu STAY**, takže byla vzhůru a pod zátěží; obě čísla jsou tedy z jednoho okamžiku a ze stejného zatížení. **Nabíječka odpojená.**
