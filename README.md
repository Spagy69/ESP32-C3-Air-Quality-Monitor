...
- **Vlnovka.** Prvních **45 min** po studeném startu se na obou teplotních stránkách i na vlhkosti zobrazuje `~` před hodnotou (`~25.1 C`) = "ještě se to zahřívá, neber to doslova". Vlhkost je tam taky proto, že ji SCD41 počítá z té samé teploty, takže se veze s ní.
