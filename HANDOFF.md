...
3. **`wakeup_pin` syntaxe pro ESP32-C3** - pořád neověřeno **na reálném hardwaru**. Probouzení časovačem funguje (9 cyklů v `data/2026-08-22-cesta-wake-cycles/`, od té doby dalších 72 v `data/2026-08-23-cesta-baseline/` bez jediného výpadku), probuzení **tlačítkem** nikdo nezkusil.
