...
- **Napětí děliče multimetrem ve spodku rozsahu** - násobič 3.2 je ověřený ve dvou bodech: 4.15 V a **3.81 V** (28. 8. 2026, HA 3.81 proti multimetru 3.81-3.82, tedy shoda v mezích odečtu). Tím zároveň padlo podezření, že dělič podhodnocuje o ~2 % - taková chyba by při 3.81 V dělala 76 mV a byla by vidět. **Plná baterka opravdu končí kolem 4.12 V.** Zbývá odečet kolem **3.5 V a níž**, kde by se nelinearita ADC projevila nejvíc. Podmínky odečtu z 28. 8.: sonda na **B+ přímo na baterce**, černá na **GND XIAO** - tedy proti té samé zemi, proti které měří ADC, takže se do srovnání nemíchá úbytek na trase. Krabička v **CESTA** s rozsvíceným displejem v režimu **STAY** (vzhůru, pod zátěží), **nabíječka odpojená**.
